...
public static class SeedSqlCommand
{
    public static Command Build(
        IDataLoadService dataLoadService,
        ISchemaInferenceService schemaService,
        ISeedSqlGeneratorService seedSqlService,
        IValidationService validationService)
    {
        var command = new Command("seed-sql", "Generate INSERT statements from an Excel file");
        ...
        command.SetAction((ParseResult result) =>
        {
            ...
            var sql = seedSqlService.GenerateSeed(data, schema);
